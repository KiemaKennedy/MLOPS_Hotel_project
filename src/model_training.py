# Data Splitting
# Model Training - LGBM Model used
# Model Evaluation
# Model Saving
...
from sklearn.model_selection import RandomizedSearchCV  # getting the best model - based on hyperparamaters
...
class ModelTraining:
    ...
    # Split the data - between our input data (all the other fields) and our target field (booking_status)
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            best_params = random_search.best_params_  # best hyperparameters - that gave the highest accuracy
            best_lgbm_model = random_search.best_estimator_  #best model
    ...
    def evaluate_model(self , model , X_test , y_test):
        try:
            ...
            # Metrics being used for evaluation
