...
class DataProcessor:
    ...
    # ensure input and target data are almost the same
    # SMOTE (Synthetic Minority Oversampling Technique) - Oversample minority class
    ...
    # Good to select the most important data
    # Use RandomForestClasifier feature important technique
